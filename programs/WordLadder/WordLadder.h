...
class WordLadder {
  ...
  private:
    ...
    bool oneLetterDifference(const string &, const string &); // checks if both words passed in have a letter difference
    bool wordExists(const string &); //checks if word exists in dictionary
